...
export interface XFW7TokenInterface extends utils.Interface {
  contractName: "XFW7Token";
  functions: {
...
export interface XFW7Token extends BaseContract {
  contractName: "XFW7Token";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: XFW7TokenInterface;
